...
PERSONAL_BASE_DIR=~/.personal
PERSONAL_BIN_DIR=$PERSONAL_BASE_DIR/bin
PERSONAL_CONFIG_MGMT_DIR=$PERSONAL_BASE_DIR/config-mgmt
PERSONAL_DOTFILES_DIR=$PERSONAL_BASE_DIR/dotfiles
